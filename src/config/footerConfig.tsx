...
export const footerConfig = {
  ...
  newsletter: {
    title: 'Stay Updated',
    description:
      'Get the latest fuel price alerts and station updates delivered to your inbox.',
  ...
  description:
    'Find the cheapest petrol prices near you with real-time updates from 250+ stations across Melbourne. Save money on fuel with our comprehensive price comparison tool.',
};
