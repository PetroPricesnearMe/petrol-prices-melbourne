...
export function Skeleton({
  ...
  const variantClasses = {
    ...
    rectangular: 'bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700',
    circular: 'rounded-full bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700',
...
export function StationCardSkeleton() {
  return (
    <div className="card overflow-hidden">
      ...
      <div className="relative h-20 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700 animate-pulse">
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-2 flex-wrap">
        {Array.from({ length: 4 }).map((_, index) => (
          <Skeleton key={index} variant="rectangular" width={80} height={32} className="rounded-full" />
        ))}
      </div>
