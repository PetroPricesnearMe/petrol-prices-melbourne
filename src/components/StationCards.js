            ...
            {paginatedStations.map((station) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Card Content */}
                  <div className="flex flex-1 flex-col space-y-5 p-5 sm:space-y-4 sm:p-6">
                    <div className="space-y-2.5 sm:space-y-2">
                      ...
                      <p className="line-clamp-2 text-sm leading-relaxed text-gray-600 sm:text-xs">
                    ...
                    <div className="grid flex-1 grid-cols-2 gap-4 sm:gap-4">
                      {/* Unleaded Price */}
                      <div className="from-green-50 border-green-200 hover:border-green-400 relative flex min-h-[120px] touch-manipulation flex-col items-center justify-center rounded-2xl border-2 bg-gradient-to-br to-white p-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-md active:scale-[0.98] sm:min-h-[100px] sm:p-4">
                        <div className="mb-2.5 flex items-center gap-2 sm:mb-2">
                          <span className="from-green-500 to-green-600 flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br text-xs font-bold text-white shadow-sm sm:h-6 sm:w-6 sm:text-xs">
                            U
                          </span>
                          <span className="text-xs font-semibold uppercase tracking-wide text-gray-700 sm:text-xs">
                            Unleaded
                          </span>
                        </div>
                        <div className="text-green-600 text-2xl font-bold sm:text-2xl">
                      ...
                      {/* Diesel Price */}
                      <div className="from-blue-50 border-blue-200 hover:border-blue-400 relative flex min-h-[120px] touch-manipulation flex-col items-center justify-center rounded-2xl border-2 bg-gradient-to-br to-white p-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-md active:scale-[0.98] sm:min-h-[100px] sm:p-4">
                        <div className="mb-2.5 flex items-center gap-2 sm:mb-2">
                          <span className="from-blue-500 to-blue-600 flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br text-xs font-bold text-white shadow-sm sm:h-6 sm:w-6 sm:text-xs">
                            D
                          </span>
                          <span className="text-xs font-semibold uppercase tracking-wide text-gray-700 sm:text-xs">
                            Diesel
                        ...
                        <div className="text-blue-600 text-2xl font-bold sm:text-2xl">
                    ...
                    <div className="grid grid-cols-2 gap-4 border-t border-gray-100 pt-5 sm:gap-3 sm:pt-4">
                      {station.latitude && station.longitude ? (
                        <a
                          href={`https://www.google.com/maps/dir/?api=1&destination=${station.latitude},${station.longitude}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex min-h-[48px] touch-manipulation items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-primary-500 to-primary-600 px-4 py-4 text-sm font-bold text-white shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-lg active:scale-95 sm:min-h-[44px] sm:px-4 sm:py-3 sm:text-sm"
                        >
                        ...
                        <button
                          disabled
                          className="flex min-h-[48px] cursor-not-allowed items-center justify-center gap-2 rounded-xl bg-gray-300 px-4 py-4 text-sm font-bold text-gray-500 sm:min-h-[44px] sm:px-4 sm:py-3 sm:text-sm"
                        >
                          <span aria-hidden="true">📍</span>
                          <span>No Location</span>
                        </button>
                      )}
                      <button className="flex min-h-[48px] touch-manipulation items-center justify-center gap-2 rounded-xl border-2 border-primary-500 bg-white px-4 py-4 text-sm font-bold text-primary-600 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:bg-gradient-to-r hover:from-primary-500 hover:to-primary-600 hover:text-white hover:shadow-lg active:scale-95 sm:min-h-[44px] sm:px-4 sm:py-3 sm:text-sm">
