...
const AboutPage = () => {
  ...
  const aboutStructuredData = {
    ...
    description:
      "Learn about Melbourne's leading petrol price monitoring service",
    mainEntity: {
      '@type': 'Organization',
      '@id': 'https://www.petrolpricesnearme.com.au',
      name: 'Petrol Prices Near Me',
      description:
        "Australia's leading petrol price monitoring service providing real-time fuel prices across Melbourne",
      foundingDate: '2024',
      foundingLocation: {
        '@type': 'City',
        name: 'Melbourne',
      ...
      <div className="container" style={{ padding: '2rem 0' }}>
        ...
        <section style={{ display: 'grid', gap: '1rem' }}>
          ...
          >
            ...
            <p style={{ color: 'var(--text-secondary)', marginTop: '0.5rem' }}>
              ...
              autocomplete, and suburb-centric navigation.
            </p>
          </div>
        </section>
        ...
        >
          ...
          >
            ...
            save money every day. Our platform combines cutting-edge technology
            with user-friendly design to make finding cheap fuel as easy as
            possible.
          </p>
