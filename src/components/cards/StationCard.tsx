        ...
        >
          ...
          <div className="flex-shrink-0 border-b border-gray-200 p-4 dark:border-gray-700 sm:p-5 lg:p-6">
            <div className="mb-3 flex min-w-0 items-start justify-between gap-3">
              <h3
                className="min-w-0 flex-1 truncate text-base font-bold leading-tight text-gray-900 dark:text-white sm:text-lg"
                itemProp="name"
              >
                {station.name}
              </h3>
          ...
          <div className="print-hidden flex-shrink-0 border-t border-gray-200 p-4 dark:border-gray-700 sm:p-5 lg:p-6">
            <div className="btn-primary btn-sm btn pointer-events-none w-full text-xs sm:text-sm">
              View Details →
            </div>
          </div>
        </article>
