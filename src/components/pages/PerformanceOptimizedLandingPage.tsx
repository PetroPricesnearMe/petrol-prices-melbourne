  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="from-pink-400/20 to-purple-500/20 absolute bottom-20 right-20 h-96 w-96 animate-pulse rounded-full bg-gradient-to-r blur-3xl animation-delay-2000" />
      </div>
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-primary-600 via-primary-500 to-secondary-500">
                    ...
                    <div className="absolute inset-0 opacity-20">
                      ...
                      <div className="absolute bottom-10 right-10 h-40 w-40 animate-pulse-slow rounded-full bg-white/20 blur-3xl animation-delay-1000" />
                      <div className="absolute left-1/3 top-1/2 h-24 w-24 animate-pulse-slow rounded-full bg-white/25 blur-2xl animation-delay-500" />
                    </div>
                  </div>
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="from-pink-400/10 to-purple-500/10 absolute bottom-20 right-20 h-80 w-80 animate-pulse rounded-full bg-gradient-to-r blur-3xl animation-delay-2000" />
      </div>
