...
export const metadata: Metadata = generatePageMetadata({
  ...
  description:
    'A complete example of SEO and performance optimization in Next.js 14+. Includes metadata, structured data, optimized images, and Core Web Vitals optimization.',
  keywords: [
    'seo optimization',
    'next.js seo',
    'core web vitals',
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="relative h-[60vh] max-h-[600px] min-h-[400px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-black/60 to-black/40">
            <div className="mx-auto max-w-4xl px-4 text-center text-white">
              ...
              <p className="mb-8 text-xl text-gray-200 md:text-2xl">
                Best practices for Next.js 14+ with metadata, structured data,
              ...
              <Link
                href="#content"
                className="inline-block min-h-[44px] min-w-[44px] rounded-lg bg-primary-600 px-8 py-4 font-semibold text-white transition-colors hover:bg-primary-700"
              >
                Get Started
              </Link>
            </div>
        ...
        <article className="mx-auto max-w-4xl px-4 py-12">
          ...
          <section id="content" className="mb-12">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <ul>
                <li>
                  <strong>Better Rankings:</strong> Google uses Core Web Vitals
                  as ranking signals
                </li>
                <li>
                  <strong>User Experience:</strong> Fast, accessible sites keep
                  users engaged
                </li>
                <li>
                  <strong>Conversions:</strong> Every 100ms delay can reduce
                  conversions by 1%
                </li>
                <li>
                  <strong>Visibility:</strong> Rich snippets increase
                  click-through rates
                </li>
              </ul>
            </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      Complete metadata configuration using Next.js 14+ API with
                      title templates, descriptions, and Open Graph tags.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      JSON-LD schemas for Organization, LocalBusiness, FAQ,
                      Article, and more for rich search results.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      Optimized for LCP, FID, and CLS with priority loading,
              ...
              <div className="card p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      Responsive design, touch optimization, and mobile-specific
          ...
          <section className="mb-12">
            <h2 className="mb-6 text-3xl font-bold">Optimized Image Gallery</h2>

            <p className="mb-6 text-gray-600 dark:text-gray-400">
              Below-the-fold images are lazy-loaded automatically. First few
              images get priority for faster perceived performance.
            </p>
            ...
            <div className="space-y-6">
              ...
              <details className="card group p-6">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-400">
                  Follow best practices including proper metadata, structured
                  data, semantic HTML, optimized images, and fast loading times.
                  Use the Next.js Metadata API and implement JSON-LD schemas.
                </p>
              </details>
              ...
              <details className="card group p-6">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-400">
                  ...
                  user experience: LCP (loading), FID/INP (interactivity), and
                  CLS (visual stability). Aim for LCP &lt; 2.5s, FID &lt; 100ms,
                  and CLS &lt; 0.1.
                </p>
              </details>
              ...
              <details className="card group p-6">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-400">
                  Use Next.js Image component with proper dimensions, enable
                  lazy loading for below-the-fold images, use priority loading
                  for hero images, specify responsive sizes, and use appropriate
                  quality settings.
                </p>
              </details>
            </div>
          ...
          <section className="card bg-gradient-to-r from-primary-50 to-primary-100 p-8 dark:from-primary-900/20 dark:to-primary-800/20">
            <h2 className="mb-4 text-3xl font-bold">
              Ready to Optimize Your Site?
            </h2>

            <p className="mb-6 text-lg text-gray-600 dark:text-gray-400">
              Use this template as a starting point for creating SEO-optimized
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/documentation"
                className="btn-primary btn min-h-[44px]"
              >
                Read Full Documentation
              </Link>

              <Link href="/examples" className="btn-outline btn min-h-[44px]">
                View More Examples
              </Link>
            </div>
          </section>
        ...
        <aside className="bg-gray-50 py-12 dark:bg-gray-900">
          <div className="mx-auto max-w-4xl px-4">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              >
                <h3 className="mb-2 text-lg font-semibold">SEO Guide</h3>
