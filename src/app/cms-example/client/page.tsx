...
export default function CMSClientExamplePage() {
  const [initialData, setInitialData] = useState<CMSPaginatedResponse<Station> | null>(null);
  ...
  const fetchData = useCallback(
    async (page: number, filters?: any): Promise<CMSPaginatedResponse<Station>> => {
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-lg border border-red-200 bg-red-50 p-6">
            <p className="text-red-800">Failed to load data. Please try again later.</p>
          </div>
        </div>
      </main>
    );
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            This page demonstrates client-side data fetching with real-time updates
          </p>
          <div className="mt-4 rounded-lg bg-yellow-50 p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-yellow-700">
                ...
                updates dynamically. Use for interactive features that require real-time updates.
              </div>
            </div>
          </div>
        </div>
