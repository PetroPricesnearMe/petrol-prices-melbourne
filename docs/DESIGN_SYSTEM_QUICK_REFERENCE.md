...
```jsx
<section className="bg-gradient-to-br from-primary-600 to-secondary-500 py-20">
  <div className="container mx-auto px-4">
    <h1 className="mb-4 text-5xl font-extrabold text-white">Hero Title</h1>
  </div>
</section>
```
...
```jsx
<div className="fixed inset-0 z-modal-backdrop flex items-center justify-center bg-black/50">
  <div className="mx-4 w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl dark:bg-gray-800">
    <h2 className="mb-4 text-2xl font-bold">Dialog Title</h2>
    <p className="mb-6 text-gray-600 dark:text-gray-400">Content</p>
